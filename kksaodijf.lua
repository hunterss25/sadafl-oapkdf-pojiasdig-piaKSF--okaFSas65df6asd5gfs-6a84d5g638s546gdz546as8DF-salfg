HWID = "479BA819-09FA-493C-BE57-EAF8CC265E73"
...
elseif Server == "Invaid HWID !" then
    game.Players.LocalPlayer:kick("ไม่มี hwid ยังจะเสือกรัน script!")
elseif Server == "Invaid Key" then
    game.Players.LocalPlayer:kick("ไม่มี key ยังจะเสือกรัน script!")
else
    game.Players.LocalPlayer:kick("ไม่มี key ยังจะเสือกรัน script!")
end
